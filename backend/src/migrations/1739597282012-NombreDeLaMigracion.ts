...
export class NombreDeLaMigracion1739597282012 implements MigrationInterface {
    name = 'NombreDeLaMigracion1739597282012'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "t_employee_documents" ("id" SERIAL NOT NULL, "file_path" character varying NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "employeeId" integer, "documentTypeId" integer, CONSTRAINT "PK_f24bade942ef955b13ebdfccd0c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "t_employees" ("id" SERIAL NOT NULL, "job_title" character varying NOT NULL, "salary" numeric(10,2) NOT NULL, "document" character varying NOT NULL, "userId" integer, CONSTRAINT "REL_efacb5c3936d42e5ba224fedca" UNIQUE ("userId"), CONSTRAINT "PK_aa4d122590b029017d031a26123" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "t_users" ("id" SERIAL NOT NULL, "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, "password" character varying NOT NULL, "email" character varying NOT NULL, CONSTRAINT "UQ_1b1275aba2e3044ce094936619c" UNIQUE ("email"), CONSTRAINT "PK_45e27b946b7f8cd527fd4fbe658" PRIMARY KEY ("id"))`);
